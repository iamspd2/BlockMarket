...
export const ANIMALS = [
  {
    id: 'bbzr',
    name: 'Big Bazar',
    superpower: 'Get 30% off on your next purchase over Rs. 1500/-.'
  },
  {
    id: 'ifc',
    name: 'Indian Fried Chicken',
    superpower: 'Get a chicken bucket worth Rs. 200/- for free.'
  },
  {
    id: 'shl',
    name: 'ShreeLeathers',
    superpower: 'Get a voucher of Rs. 399/-.'
  }]

export const TERRITORIES = [
   {
      id: 'senco',
      name: 'Senco Jewellers & Co.',
      superpower: ' Buy 24K pure Gold and get 1kg Onion Free!'
    },
   {
    id: 'myvr',
    name: 'Manyavar',
    superpower: ' Get a printed waistcoat free with kurta!'
  },
  {
    id: 'kvtr',
    name: 'Keventers',
    superpower: ' Buy one Keventers milkshake and get one free !'
